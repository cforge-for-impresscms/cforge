...
<a href="<?php echo XOOPS_URL ?>/modules/xfmod/tos/tos.php">http://forge.novell.com/modules/xfmod/tos/tos.php</a>.  In addition, each user's use of
...
<a href="<?php echo XOOPS_URL ?>/modules/xfmod/tos/tos.php">http://forge.novell.com/modules/xfmod/tos/tos.php</a>.  Concurrently with any change to the
...
<a href="<?php echo XOOPS_URL ?>/modules/xfmod/tos/privacy.php">http://forge.novell.com/modules/xfmod/tos/privacy.php</a>.
</p>
...
Service governing usage of this site at <a href="<?php echo XOOPS_URL ?>/modules/xfmod/tos/tos.php">http://forge.novell.com/modules/xfmod/tos/tos.php</a>.
For Novell Forge privacy policy information, please see
<a href="<?php echo XOOPS_URL ?>/modules/xfmod/tos/privacy.php">http://forge.novell.com/modules/xfmod/tos/privacy.php</a>. Content owned by Novell is
