...
include_once(XOOPS_ROOT_PATH."/modules/xftrove/language/english/modinfo.php");
include_once(XOOPS_ROOT_PATH."/modules/xfnewproject/language/english/modinfo.php");
include_once(XOOPS_ROOT_PATH."/modules/xfjobs/language/english/modinfo.php");
include_once(XOOPS_ROOT_PATH."/modules/xfmod/language/english/project.php");
include_once(XOOPS_ROOT_PATH."/modules/xfmod/language/english/pm.php");
include_once(XOOPS_ROOT_PATH."/modules/xfmod/language/english/docman.php");
include_once(XOOPS_ROOT_PATH."/modules/xfmod/language/english/tracker.php");
include_once(XOOPS_ROOT_PATH."/modules/xfmod/language/english/maillist.php");
...
$content = "<p>There are three ways to access a project page."
	...
	. "<li><b>"._XF_XFTROVE_NAME."</b> - This feature presents a tree or list "
	...
	. "The format is \"http://".$_SERVER['SERVER_NAME']."/modules/xfmod/project/?shortname\", "
...
$content = "<p>To create a project, start by clicking on the \""._XF_XFNEWPROJECT_NAME
	...
	. "directed to the <a href=\"mailto:".$xoopsConfig['adminmail']."\">site "
	. "administrator</a>."
	...
	. "<a href=\"".XOOPS_URL."/modules/xfmod/help/software_map.php#categorizing_projects\">"
...
$content = "<p>There are many ways you can contribute to a project."
	...
	. "You can also check the \""._XF_XFJOBS_NAME."\" section by clicking on the link in "
...
$content = "<p>First off, you must be an administrator of a project in order to perform "
	...
	. "<p>Clicking on the \""._XF_G_ADMIN."\" link in the project menu will take you "
	. "to the primary project administration page.  This page has several subsections."
	. "<ul><li><b>"._XF_G_ADMIN."</b> - This is the main project administrative page.  "
	. "From this page you can perform the following tasks:"
	. "<ul><li><a href=\"".XOOPS_URL."/modules/xfmod/help/software_map.php#categorizing_projects\">"
	...
	. "<li>Add users to your project - simply enter their username and click \""._XF_PRJ_ADDUSER."\"</ul>"
	. "<li><b>"._XF_PRJ_USERPERMISSIONS."</b> - From within this page you will see an "
	...
	. "<li><b>"._XF_PRJ_EDITPUBLICINFO."</b> - This page allows you to modify the "
	...
	. "<li><b>"._XF_PRJ_PROJECTHISTORY."</b> - You can use this page to quickly view a "
	. "log of the administrative changes that have taken place within your project."
	. "<li><b>"._XF_PRJ_EDITRELEASEFILES."</b> - It is within this page that you create "
	...
	. "<li><b>"._XF_PRJ_POSTJOBS."</b> - You can use this page to post jobs for your "
	. "project that will appear in the \""._XF_XFJOBS_NAME."\" section.  This is a good "
	. "way to advertise to get additional help on your project."
	. "<li><b>"._XF_PRJ_EDITJOBS."</b> - From within this page, you will see a view of "
	...
	. "the tool in the project menu, then click on the \""._XF_G_ADMIN."\" link that "
	. "appears.";
...
$content = "<p>Within a project, the files that you can download are organized as follows:"
	...
	. "the files available for download are listed underneath the heading \""._XF_PRJ_LATESTFILERELEASES
...
$content = "<p>Trackers allow you to create categories and issues within categories for "
	...
	. "To administer this page, click on the \""._XF_G_ADMIN."\" link.  Here you can:"
	...
	. _XF_TRK_UPDATEPREFERENCES."\" link and deselecting the \""
	. _XF_TRK_PUBLICLYAVAILABLE."\" setting</ul>"
	...
	. "menu, from the main project page, or by clicking on the \""._XF_G_TRACKERS."\" link "
...
$content = "<p>Tasks provide a means by which a project administrator can assign and "
	...
	. "project."
	. "<p>To create a subproject, you first click on the \""._XF_PM_TASKS."\" link in "
	. "the project menu, then click on \""._XF_G_ADMIN."\", \""._XF_PM_SUBPROJECTLIST
	. "\", and \""._XF_PM_ADDASUBPROJECT."\".  Fill in the simple form and submit to "
	. "create a subproject."
	. "<p>To manage a task, go to the tasks window by clicking on the \""._XF_PM_TASKS
...
$content = "<p>$site offers you the ability to upload and manage all types of documents "
	...
	. "<p>To access the documentation page, click on the \""._XF_G_DOCS."\" link "
	. "in the project or community menu.  You will be presented with all the publicly "
	. "available documents.  By clicking on the \""._XF_G_ADMIN."\" link, you will go "
	...
	. "<p>To submit a document, click on the \""._XF_DOC_SUBMITNEWDOC."\" link in the "
...
$content = "<p>Mailing lists are offered for both projects and communities.  A set of "
	...
	. $_SERVER['SERVER_NAME'].", where \"list-name\" is the name of the list."
	...
	. _XF_ML_SUBSCRIBE."\" link.  Then fill out the form and submit.  You will receive "
...
$content = "<p>You can create your own news items for your project.  This is a good way "
	 . "to provide summary information about the current state of your project."
	 . "<p>Check the <a href=\"news.php\">News</a> help page for more information.";
...
$content = "<p>CVS is the source code repository control system used by $site.  When "
	...
	. "To enable anonymous CVS access, click the \""._XF_G_ADMIN."\" link in your project "
...
$content = "<p>The Red Carpet clients are available for download from ximian's website, 
					...
					as the project's shortname.</p>"
					."<p><b>GUI Client Example:</b><br>If you were using the red-carpet GUI client and wanted to install files from the forge project you would do the following:
					<ul>
					...
					."<p><b>Command Line Example</b><br>If you were using the rug command line client and wanted to install files from teh forge project you would do the following:
					<ul>
