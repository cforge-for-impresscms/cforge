<?php
	...
	*/
	...
	if ($group_id)
	{
		...
		// echo "<strong style='font-size:16px;align:left;'>" ._XF_ML_LISTS. "</strong><br />\n";
		...
		if ($dosub == "y")
		{
			...
			else if(! maillist_subscribe(0, 0, $_SERVER['SERVER_NAME'], $list, 0, $email, $pw, $digest))
			{
				...
				{
				echo "<h5>"._XF_ML_NOWSUBDTO . " " . $list . "</h5>" . "<br><br>" . "<a href=\"".ICMS_URL."/modules/xfmod/project/?".$project->getUnixName()."\">" . _LOCAL_XF_ML_RETURNTOPRJPAGE . "</a>";
			}
		}
		if ($dosub != "y" || $feedback != "")
		{
