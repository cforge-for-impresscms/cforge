...
function show_pref(){
	...
	// Elements
	 $send_date_hour = array($xoopsNewsLetterConfig['next_send_date_hour'] => $xoopsNewsLetterConfig['next_send_date_hour'],
    		 	                  "01" => "01",
  					  "02" => "02",
    		                          "03" => "03",
    		                          "04" => "04",
    		                          ...
    		                          "23" => "23",
    		                          "24" => "24");
	$send_date_day  = array ($xoopsNewsLetterConfig['next_send_date_day'] => $xoopsNewsLetterConfig['next_send_date_day'],
    		                         "01" => "01",
    		                         "02" => "02",
    		                         "03" => "03",
    		                         "04" => "04",
    		                         ...
    		                         "30" => "30",
    		                         "31" => "31");
    		 $send_date_month = array($xoopsNewsLetterConfig['next_send_date_month'] => $xoopsNewsLetterConfig['next_send_date_month'],
    		 	                  "01" => "01",
  					  "02" => "02",
    		                          "03" => "03",
    		                          "04" => "04",
    	       	 ...
    	       	 $send_date_year = array($xoopsNewsLetterConfig['next_send_date_year'] => $xoopsNewsLetterConfig['next_send_date_year'],
    		 	                  "".date("Y") => date("Y"),
  					  "".date("Y")+1 => date("Y")+1,
    		                          "".date("Y")+2 => date("Y")+2);

    		$send_interval_days = array( $xoopsNewsLetterConfig['next_send_interval_days'] =>  $xoopsNewsLetterConfig['next_send_interval_days'],
					  "01" => "01",
  					  "02" => "02",
    		                          "03" => "03",
    		                          "04" => "04",
       		...
       		$next_send_date_hour = new XoopsFormSelect("Hour", "next_send_date_hour", $xoopsNewsLetterConfig['next_send_date_hour']);
		$next_send_date_hour->addOptionArray($send_date_hour);
		$next_send_date_day = new XoopsFormSelect("Day", "next_send_date_day", $xoopsNewsLetterConfig['next_send_date_day']);
		$next_send_date_day->addOptionArray($send_date_day);
		$next_send_date_month = new XoopsFormSelect("Month", "next_send_date_month", $xoopsNewsLetterConfig['next_send_date_month']);
		$next_send_date_month->addOptionArray($send_date_month);
		$next_send_date_year = new XoopsFormSelect("Year", "next_send_date_year", $xoopsNewsLetterConfig['next_send_date_year']);
		$next_send_date_year->addOptionArray($send_date_year);
 		$next_date = date("M d, Y h:i A",mktime($xoopsNewsLetterConfig['next_send_date_hour'],0,0,$xoopsNewsLetterConfig['next_send_date_month'],$xoopsNewsLetterConfig['next_send_date_day'],$xoopsNewsLetterConfig['next_send_date_year']));
                ...
                $next_send_date_tray->addElement($next_send_date_year);
              	...
              	$next_send_interval_days = new XoopsFormSelect("Interval (Days)", "next_send_interval_days", $xoopsNewsLetterConfig['next_send_interval_days']);
		$next_send_interval_days->addOptionArray($send_interval_days);
                $autosend_active =  new XoopsFormCheckBox("", "autosend_active", $xoopsNewsLetterConfig['autosend_active']);
	 	...
	 	$subject = new XoopsFormText("Newsletter Subject", "subject", 30, 60, $xoopsNewsLetterConfig['subject']);
	 	$subject_tray = new XoopsFormElementTray("Subject","&nbsp;");
	 	$subject_tray->addElement($subject_body);

	 	$header_active =  new XoopsFormCheckBox("", "header_active", $xoopsNewsLetterConfig['header_active']);
	 	$header_active->addOption(1, "Header - Active?<BR>");
	 	$header_body = new XoopsFormTextArea("<BR>", "header_body", $xoopsNewsLetterConfig['header_body'], 10);
	 	$header_tray = new XoopsFormElementTray("Header","&nbsp;");
	 	$header_tray->addElement($header_active);
	 	$header_tray->addElement($header_body);

 	 	$body_active =  new XoopsFormCheckBox("", "body_active", $xoopsNewsLetterConfig['body_active']);
	 	$body_active->addOption(1, "Body - Active?<BR>");
	 	$body_body = new XoopsFormTextArea("<BR>", "body_body", $xoopsNewsLetterConfig['body_body'], 10);
	 	$body_tray = new XoopsFormElementTray("Body","&nbsp;");
	 	$body_tray->addElement($body_active);
	 	$body_tray->addElement($body_body);

       	 	$topdownloads_active =  new XoopsFormCheckBox("", "topdownloads_active", $xoopsNewsLetterConfig['topdownloads_active']);
	 	...
	 	$topdownloads_tray->addElement($topdownloads_active);
   	 	...
   	 	$topactive_projects_active =  new XoopsFormCheckBox("", "topactive_projects_active", $xoopsNewsLetterConfig['topactive_projects_active']);
   		...
   		$topactive_projects_tray = new XoopsFormElementTray("Top Active Projects","&nbsp;");
   	 	$topactive_projects_tray->addElement($topactive_projects_active);
    	 	...
    	 	$spotlight_user_active =  new XoopsFormCheckBox("", "spotlight_user_active", $xoopsNewsLetterConfig['spotlight_user_active']);
   	 	...
   	 	$user_select = new XoopsFormSelect("User to Spotlight", "spotlight_user_id");
          	$user_select->addOptionArray(XoopsUser::getAllUsersList(array(), $orderby="uname ASC"));
   		...
   		$spotlight_user_tray->addElement($user_select);
    	 	...
    	 	$spotlight_community_active =  new XoopsFormCheckBox("", "spotlight_community_active", $xoopsNewsLetterConfig['spotlight_community_active']);
   		...
   		$spotlight_community_tray = new XoopsFormElementTray("Spotlight Community","&nbsp;");
   	 	...
   	 	$spotlight_community_tray->addElement($community_select);
    	 	...
    	 	$spotlight_project_active =  new XoopsFormCheckBox("", "spotlight_project_active", $xoopsNewsLetterConfig['spotlight_project_active']);
   		...
   		$spotlight_project_tray = new XoopsFormElementTray("Spotlight Project","&nbsp;");
   	 	...
   	 	$spotlight_project_tray->addElement($project_select);
                ...
                $newest_projects_active =  new XoopsFormCheckBox("", "newest_projects_active", $xoopsNewsLetterConfig['newest_projects_active']);
   		...
   		$newest_projects_tray = new XoopsFormElementTray("Newest Projects","&nbsp;");
   	 	$newest_projects_tray->addElement($newest_projects_active);
                ...
                $newest_communities_active =  new XoopsFormCheckBox("", "newest_communities_active", $xoopsNewsLetterConfig['newest_communities_active']);
	 	...
	 	$footer_active =  new XoopsFormCheckBox("", "footer_active", $xoopsNewsLetterConfig['footer_active']);
	 	$footer_active->addOption(1, "Footer - Active?<BR>");
	 	$footer_body = new XoopsFormTextArea("<BR>", "footer_body", $xoopsNewsLetterConfig['footer_body'], 10);
	 	$footer_tray = new XoopsFormElementTray("Footer<BR><BR><b>Useful Tags:</b><BR>{XOOPS_URL} will print URL link","&nbsp;");
