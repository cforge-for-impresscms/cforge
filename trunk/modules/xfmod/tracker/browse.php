...
$xoopsOption['template_main'] = 'tracker/xfmod_browse.html';
...
<TABLE WIDTH="10%" BORDER="0">
	...
	<TR>
		<TD><FONT SIZE="1">'._XF_TRK_ASSIGNEE.':<BR>'. $tech_box .'</TD>'.
	'<TD><FONT SIZE="1">'._XF_TRK_STATUS.':<BR>'. $ath->statusBox('_status',$_status,true,_XF_G_ANY) .'</TD>'.
	'<TD><FONT SIZE="1">'._XF_TRK_CATEGORY.':<BR>'. $ath->categoryBox ('_category',$_category,_XF_G_ANY) .'</TD>'.
	'<TD><FONT SIZE="1">'._XF_TRK_GROUP.':<BR>'. $ath->artifactGroupBox ('_group',$_group,_XF_G_ANY) .'</TD>
	</TR>
	<TR>
		<TD ALIGN="RIGHT"><FONT SIZE="1">'._XF_TRK_SORTBY.':</TD>'.
		'<TD><FONT SIZE="1">'.
		...
		'<TD><FONT SIZE="1"><INPUT TYPE="SUBMIT" NAME="SUBMIT" VALUE="'._XF_G_BROWSE.'"></TD>
	</TR>
	</FORM></TABLE>';
...
$sql = "SELECT a.priority,a.group_artifact_id,a.artifact_id,a.summary,"
      ."a.open_date AS date,u.uname AS submitted_by,u2.uname AS assigned_to,ar.resolution_name "
			."FROM ".$xoopsDB->prefix("xf_artifact")." a,".$xoopsDB->prefix("xf_artifact_resolution")." ar,".$xoopsDB->prefix("users")." u,".$xoopsDB->prefix("users")." u2 "
			...
			."AND a.group_artifact_id='".$ath->getID()."' "
