...
$content="<ul><li>To view a <b>project</b> forum, click on either the \""._XF_G_FORUMS."\" link "
	. "in the project menu, or the \""._XF_PRJ_PUBLICFORUMS."\" link in the project "
	. "public area.  Click on the forum of interest to view the postings in the forum."
	. "<li>To view a <b>community</b> forum, click on either the \""._XF_G_FORUMS."\" link "
	. "in the community menu, or the \""._XF_COMM_PUBLICFORUMS."\" link in the community "
	...
	. " You can access the xml document by clicking on the <img src='".XOOPS_URL."/modules/xfmod/newsportal/img/xml.gif' width='36 height='14' alt='RSS Feed'> image."
...
$content="<p>You may post to the forum either through you news reader or through the web"
	...
	. _XF_FRM_STARTNEWTHREAD."\".  Fill in the form and click on the \""._XF_FRM_POSTCOMMENT
	...
	. "a form with the label \""._XF_FRM_POSTFOLLOWUP."\".  Fill in the form and click "
	. "on the \""._XF_FRM_POSTCOMMENT."\" button to post a follow-up message to the thread."
...
$content="<p>Project or community forums can only be created by an administrator of "
	...
	. "<p>To create a project or community forum, first click on the \""._XF_G_FORUMS
	. "\" link in the project or community menu, then click on the \""._XF_G_ADMIN
