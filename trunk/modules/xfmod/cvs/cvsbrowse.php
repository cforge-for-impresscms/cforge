...
include_once(XOOPS_ROOT_PATH."/modules/xfmod/include/httpClient.php");
include_once(XOOPS_ROOT_PATH."/modules/xfmod/include/checkurl.php");
...
if( $status != 200 )
{
	echo "<b>Problem contacting server " . $cvsdns . " : " .
		$http->getStatusMessage() . "</b><br/>";
	$http->Disconnect();
	exit();
}
else
