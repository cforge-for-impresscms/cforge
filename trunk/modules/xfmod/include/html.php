...
function html_build_priority_select_box ($name='priority', $checked_val='5', $nochange=false) {
	...
	$content .= '<OPTION VALUE="1"';
		if ($checked_val=="1") { $content .= ' SELECTED'; } $content .='>1 - '._XF_HTM_LOWEST.'</OPTION>';
	$content .= '<OPTION VALUE="2"';
		if ($checked_val=="2") { $content .= ' SELECTED'; } $content .='>2</OPTION>';
	$content .= '<OPTION VALUE="3"';
		if ($checked_val=="3") { $content .= ' SELECTED'; } $content .='>3</OPTION>';
	$content .= '<OPTION VALUE="4"';
		if ($checked_val=="4") { $content .= ' SELECTED'; } $content .='>4</OPTION>';
	$content .= '<OPTION VALUE="5"';
		if ($checked_val=="5") { $content .= ' SELECTED'; } $content .='>5 - '._XF_HTM_MEDIUM.'</OPTION>';
	$content .= '<OPTION VALUE="6"';
		if ($checked_val=="6") { $content .= ' SELECTED'; } $content .='>6</OPTION>';
	$content .= '<OPTION VALUE="7"';
		if ($checked_val=="7") { $content .= ' SELECTED'; } $content .='>7</OPTION>';
	$content .= '<OPTION VALUE="8"';
		if ($checked_val=="8") { $content .= ' SELECTED'; } $content .='>8</OPTION>';
	$content .= '<OPTION VALUE="9"';
		if ($checked_val=="9") { $content .= ' SELECTED'; } $content .='>9 - '._XF_HTM_HIGHEST.'</OPTION>';
	$content .= '</SELECT>';
