...
$sql = "INSERT INTO ".$dbprefix."_xf_project_counts_weekly_tmp "
      ."SELECT fgl.group_id,'forum',LOG(10 * (COUNT(f.msg_id)+1)) AS count "
			."FROM ".$dbprefix."_xf_forum f,".$dbprefix."_xf_forum_group_list fgl "
...
$sql = "INSERT INTO ".$dbprefix."_xf_project_counts_weekly_tmp "
      ."SELECT pgl.group_id,'tasks',LOG(12 * (COUNT(pt.project_task_id)+1)) AS count "
			."FROM ".$dbprefix."_xf_project_task pt,".$dbprefix."_xf_project_group_list pgl "
...
#bugs
$sql = "INSERT INTO ".$dbprefix."_xf_project_counts_weekly_tmp "
      ."SELECT agl.group_id,'bugs',LOG(12 * (COUNT(*)+1)) AS count "
			."FROM ".$dbprefix."_xf_artifact_group_list agl,".$dbprefix."_xf_artifact a "
...
#support
$sql = "INSERT INTO ".$dbprefix."_xf_project_counts_weekly_tmp "
      ."SELECT agl.group_id,'support',LOG(15 * (COUNT(*)+1)) AS count "
			."FROM ".$dbprefix."_xf_artifact_group_list agl,".$dbprefix."_xf_artifact a "
			."WHERE a.open_date > '$last_week' "
			."AND a.open_date < '$this_week' "
			."AND a.group_artifact_id=agl.group_artifact_id "
...
#patches
$sql = "INSERT INTO ".$dbprefix."_xf_project_counts_weekly_tmp "
      ."SELECT agl.group_id,'patches',LOG(12 * (COUNT(*)+1)) AS count "
			."FROM ".$dbprefix."_xf_artifact_group_list agl,".$dbprefix."_xf_artifact a "
			."WHERE a.open_date > '$last_week' "
			."AND a.open_date < '$this_week' "
			."AND a.group_artifact_id=agl.group_artifact_id "
...
#bugs
$sql = "INSERT INTO ".$dbprefix."_xf_project_counts_weekly_tmp "
      ."SELECT agl.group_id,'features',LOG(12 * (COUNT(*)+1)) AS count "
			."FROM ".$dbprefix."_xf_artifact_group_list agl,".$dbprefix."_xf_artifact a "
			."WHERE a.open_date > '$last_week' "
			."AND a.open_date < '$this_week' "
			."AND a.group_artifact_id=agl.group_artifact_id "
...
#Others
$sql = "INSERT INTO ".$dbprefix."_xf_project_counts_weekly_tmp "
      ."SELECT agl.group_id,'artifacts',LOG(12 * (COUNT(*)+1)) AS count "
			."FROM ".$dbprefix."_xf_artifact_group_list agl,".$dbprefix."_xf_artifact a "
			."WHERE a.open_date > '$last_week' "
			."AND a.open_date < '$this_week' "
			."AND a.group_artifact_id=agl.group_artifact_id "
...
#file releases
$sql = "INSERT INTO ".$dbprefix."_xf_project_counts_weekly_tmp "
      ."SELECT fp.group_id,'filereleases',LOG(15 * (COUNT(*)+1)) AS count "
			."FROM ".$dbprefix."_xf_frs_release fr,".$dbprefix."_xf_frs_package fp "
			."WHERE fp.package_id=fr.package_id "
			."AND fr.release_date > '$last_week' "
			."AND fr.release_date < '$this_week' "
...
$sql = "INSERT INTO ".$dbprefix."_xf_project_metric_weekly_tmp1 (group_id,value) "
      ."SELECT pcwt.group_id,SUM(pcwt.count) AS value "
			."FROM ".$dbprefix."_xf_project_counts_weekly_tmp pcwt "
			."WHERE pcwt.count > 0 "
...
$sql = "INSERT INTO ".$dbprefix."_xf_project_weekly_metric (ranking,percentile,group_id) "
//      ."SELECT ranking,(100 - (100 * ((value - 1) / $counts) ) ),group_id "
//		. "SELECT ranking,100*((value-$low)/($high-$low)),group_id "
		. "SELECT ranking,IF(100*((value-$low)/($high-$low))>0,100*((value-$low)/($high-$low)),0),group_id "
			."FROM ".$dbprefix."_xf_project_metric_weekly_tmp1 "
