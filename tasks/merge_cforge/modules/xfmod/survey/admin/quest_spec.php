<?php
	...
	*/
	...
	$uparrowUrl = "".ICMS_URL."/modules/xfmod/images/uparrow.gif";
	$downarrowUrl = "".ICMS_URL."/modules/xfmod/images/downarrow.gif";
	$leftarrowUrl = "".ICMS_URL."/modules/xfmod/images/leftarrow.gif";
	$rightarrowUrl = "".ICMS_URL."/modules/xfmod/images/rightarrow.gif";
