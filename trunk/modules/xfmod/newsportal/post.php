...
if ($testnewsgroups == "") {
  ...
  echo '<h1 align="center">'.$text_post["group_head"]
...
<tr>
	...
	<td align="left">
	<?php echo $xoopsUser->getVar('name')?$xoopsUser->getVar('name'):$xoopsUser->getVar('uname'); ?><BR>	
	<input type="text" name="email" value="<?php echo $xoopsUser->getVar('email'); ?>" size="40" maxlength="80">
	<input type="hidden" name="realname" value="<?php echo $xoopsUser->getVar('name')?$xoopsUser->getVar('name'):$xoopsUser->getVar('uname'); ?>">
	</td>
</tr>
<tr>
...
echo "//--></script>\n";
if($xoopsUser->getVar("attachsig")) echo 'xoopsCodeSmilie("body",sig)';
?>
