...
$project = (isset ( $_GET ['project'] )) ? trim ( StopXSS ( $_GET ['project'] ) ) : ((isset ( $_POST ['project'] )) ? trim ( StopXSS ( $_POST ['project'] ) ) : '');
...
define("_XF_STEP3", "
	<!--P><strong><I>If you are applying for a website-only project, please
...
define("_XF_REG_WELCOME1", "
	...
	<p>
	<strong>Use of Project Account</strong>
	</p>
	...
	<p>
	<strong>Open Source/Rights to Code</strong>
	</p>
...
define("_XF_REG_WELCOME2", "
	...
	".ICMS_URL."/modules/xfmod/tos/tos.php.  In addition, each user's use of
	...
	".ICMS_URL."/modules/xfmod/tos/tos.php.  Concurrently with any change to the
	...
	".ICMS_URL."/modules/xfmod/tos/privacy.php.
	...
	Service governing usage of this site at ".ICMS_URL."/modules/xfmod/tos/tos.php.
	For Novell Forge privacy policy information, please see
	".ICMS_URL."/modules/xfmod/tos/privacy.php. Content owned by Novell is
