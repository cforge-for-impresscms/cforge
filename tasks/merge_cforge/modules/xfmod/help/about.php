<?php
	...
	*/
	...
	$content = "<p>$site is the result of mixing many open source technologies with key
		...
		<ul>
		<li><strong>Content Management Framework</strong> - We used the basic content management
		...
		<li><strong>Code Collaboration Support</strong> - We used the
		...
		<li><strong>Web Server</strong> - We use the <a href=\"http://www.apache.org/\">Apache</a> web
		server to serve the pages.  No modification of Apache in the way of additional Apache
		modules was required.
		<li><strong>Database</strong> - Xoops is built to utilize
		...
		<li><strong>Source Code Control</strong> - We used <a href=\"http://www.cvshome.org/\">CVS</a>
		as the repository for source code for projects.
		<li><strong>Source Code Repository Browsing via Web</strong> - One key feature missing from
		...
		<li><strong>Mailing list support</strong> - Another key feature missing from XoopsForge that we
		...
		<li><strong>User Authentication and Authorization</strong> - A key requirement for us was to not
