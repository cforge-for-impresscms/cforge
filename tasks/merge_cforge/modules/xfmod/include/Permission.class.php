<?php
	...
	*/
	...
	require_once(ICMS_ROOT_PATH."/class/icmsModule.php");
	...
	*/
	function fetchData()
	{
		$res = $this->db->query("SELECT * FROM ".$this->db->prefix("xf_user_group")." " ."WHERE user_id='". $this->User->getVar("uid") ."' " ."AND group_id='". $this->Group->getID() ."'");
	...
	*/
	function isSuperUser()
	{
		if ($this->User != NULL)
		{
			$xfmod = icmsModule::getByDirname("xfmod");
