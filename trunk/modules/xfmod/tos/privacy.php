...
/**
  *
  * Novell Forge Privacy Policy
  *
  * Novell Forge: Breaking Down the Barriers to Open Source Development
  * Copyright 1999-2001 (c) VA Linux Systems
  * http://Novell Forge.net
  *
  * @version   $Id: privacy.php,v 1.3 2004/01/13 17:01:01 devsupaul Exp $
  *
  */
...
<p>
<h2>Novell Forge Privacy Policy</h2>
</p>

<p>
At Novell Forge, we intend to give you as much control as possible over your
...
access to and use of Novell Forge and/or the Services.
</p>
...
<p>
Novell Forge will track the domains from which people visit Novell Forge and
analyze this data for trends and statistics.  Subject to the provisions of
this Privacy Policy, different Novell Forge sites may use accumulated data
for different purposes, including but not limited to marketing analysis,
service evaluation and planning.
</p>

<p>
Novell Forge contains links to other Websites, whether owned or controlled by
Novell Forge affiliates or unrelated third parties.  Novell Forge is not
responsible for the privacy policies and practices of any linked Website.
</p>

<p>
Currently, Novell Forge uses personal information as a basis for
...
choose to post) are publicly available on the Novell Forge site, unless a
...
<p>
Subject to the foregoing, Novell Forge may conduct surveys of other studies
...
the time they take the survey and Novell Forge will disclose only aggregate
...
allow users to submit written comments, and where Novell Forge advises users
of the possibility of such disclosure at the time they take the survey,
Novell Forge reserves the right to disclose text information provided by any
...
<p>
Cookies:  Novell Forge employs "cookies" to provide a user with tailored
...
that element on the user's hard drive or memory.  Novell Forge uses cookies
to better serve users who use our Services; any cookies sent by Novell Forge
...
the relevant Novell Forge site, Novell Forge may use personal information to
...
authorizes such disclosure, will Novell Forge disclose individual user
personal information that is not publicly available to unrelated third
parties.
</p>

<p>
Surveys and Resulting Information:  Subject to the foregoing, Novell Forge
...
user's option;  Novell Forge does not conduct mandatory surveys.
</p>
...
notified at the time they take the survey and Novell Forge will disclose
only aggregate information regarding its users and not personal information
identifying any specific individual.  Circumstances under which Novell Forge
...
to Novell Forge advertisers on user preferences and/or demographics, and
...
written comments, and where Novell Forge advises users of the possibility of
such disclosure at the time they take the survey, Novell Forge reserves the
...
update their personal information directly through Novell Forge Service.
When such updating service is not technically feasible, Novell Forge will
...
<p>
To secure site integrity, Novell Forge employs measures including but not
...
<p>
In the event that Novell Forge becomes aware that site security is
...
external security attacks, Novell Forge shall take reasonable measures which
...
<p>
If Novell Forge becomes aware that a user's personal information provided to
Novell Forge has been disclosed in a manner not permitted by this Privacy
Policy, Novell Forge shall make reasonable efforts to notify the affected
user, as soon as reasonably possible and as permitted by law, of what
information has been disclosed, to the extent that Novell Forge knows this
information.
</p>
...
effective date at <a href="<?php echo XOOPS_URL ?>/modules/xfmod/tos/privacy.php">http://forge.novell.com/modules/xfmod/tos/privacy.php</a>.  Concurrently with
