<?php
	...
	{
		global $icmsDB;
		$sql = "SELECT  ver.snippet_id, ver.date, ver.submitted_by, snip.description" ." FROM ".$icmsDB->prefix("xf_snippet")." AS snip" .", ".$icmsDB->prefix("xf_snippet_version")." AS ver" ." WHERE snip.snippet_id=ver.snippet_id" ." AND ver.submitted_by=$userid";
