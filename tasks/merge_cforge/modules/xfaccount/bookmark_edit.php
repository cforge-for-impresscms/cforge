<?php
	...
	*/
	...
	echo "<h4 style='text-align:left;'>"._XF_MY_EDITBOOKMARK.": ".$icmsUser->getVar("name")."</h4>";
	...
	$sql = "SELECT * FROM ".$icmsDB->prefix("xf_user_bookmarks")
	." WHERE bookmark_id='".$bookmark_id ."' AND user_id='".$icmsUser->getVar("uid")."'";
...
<?php
	...
	print "<p><a href='".ICMS_URL."/modules/xfaccount/'>"._XF_G_BACK."</a>";
