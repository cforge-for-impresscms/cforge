...
include_once(XOOPS_ROOT_PATH."/modules/xfmod/language/english/people.php");
...
$content="<p>To view open job postings, click on the \""._XF_XFJOBS_NAME."\" link in the "
...
$content="<p>If you want to contribute to a project or a community, it is a good idea "
	...
	. _XF_XFACCOUNT_NAME."\" link in the main menu to get to your personal page, then "
	. "click on the \""._XF_MY_SKILLPROFILE."\" link to go to your skills profile page."
	...
	. "<p>Under the \""._XF_PEO_ADDANEWSKILL."\" heading, you will see a form where you "
	...
	. "<li>Click the \""._XF_PEO_ADDSKILL."\" button to add the skill</ol>"
	...
	. _XF_G_UPDATE."\" button to the right of that skill.  You may also delete a skill "
	. "by clicking on the \""._XF_G_DELETE."\" button to the right of the skill."
...
$content="<p>Once you have set up your skills profile, you are ready to apply for any "
	...
	. "job detail page, toward the bottom you will see the \""._XF_PEO_APPLY."\" button.  "
...
$content="<p>Administrators of projects and communities can post jobs for their project "
	. "or community.  To do so, click the \""._XF_G_ADMIN."\" link in the project or "
	. "community menu, then select the \""._XF_PRJ_POSTJOBS."\" link.  You will see a "
	...
	. "jobs in the \""._XF_XFJOBS_NAME."\" section.  The long description will be "
	. "displayed on the job detail page."
	. "<p>After clicking the \""._XF_PEO_CONTINUE."\" button, your job is posted.  You "
...
$content="<p>Administrators of projects and communities can edit jobs they have posted "
	. "for their project or community at any time.  Begin by clicking the \""._XF_G_ADMIN
	. "\" link in the project or community menu, and then clicking the \""
	. _XF_PRJ_EDITJOBS."\" link.  You will see all the open jobs for your project or "
	. "community.  Click on the job you want to edit to view the job detail page, then "
	. "click the \""._XF_PEO_EDITJOB."\" link.  You will be presented with the same "
	. "form used to create the job."
	. "<p>Simply make any changes you want to make within the form.  When you are done "
	. "making changes, click on the \""._XF_PEO_FINISHED."\" button to save your changes.";
