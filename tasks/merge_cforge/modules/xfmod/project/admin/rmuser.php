<?php
	...
	*/
	...
	$icmsOption['template_main'] = 'project/admin/xfmod_rmuser.html';
	...
	$content = "<B style='font-size:16px;align:left;'>"._XF_PRJ_MEMBERADMINISTRATION."</strong><br /><p>";
