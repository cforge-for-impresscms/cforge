...
define("_XF_MY_PROJECTADMINERROR","Operation Not Permitted<br />You cannot remove yourself from this project, because "
                                 ."you are admin of it. You should ask an other admin to reset "
													    	 ."your admin privilege first. If you are the only admin of "
												    		 ."the project, please consider posting availability notice to "
															   ."<a href='".XOOPS_URL."/modules/xfjobs/createjob.php?group_id=%s'>Help Wanted Board</a> and be ready to " // %s is group_id
...
define("_XF_MY_ADDEDBOOKMARK","Added bookmark for <b>'%s'</b> with title <b>'%s'</b>."); // 1. Bookmark URL 2. Bookmark Title
