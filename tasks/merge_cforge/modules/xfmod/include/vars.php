<?php
	...
	*/
	require_once(ICMS_ROOT_PATH."/modules/xfmod/include/cache.php");
	...
	function get_license_list()
	{
		...
		$sql = "SELECT trove_cat_id FROM ".$icmsDB->prefix("xf_trove_cat")." WHERE fullname='License'";
		$result = $icmsDB->query($sql);
		$row = $icmsDB->fetchArray($result);
		$licenseID = $row['trove_cat_id'];
		 
		$sql = "SELECT trove_cat_id, parent, shortname, fullname, description" ." FROM ".$icmsDB->prefix("xf_trove_cat")
