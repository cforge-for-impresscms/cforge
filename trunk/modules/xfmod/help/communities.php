...
$content = "<p>The easiest way to find a community is to look for the name of the "
	...
	. "The format is \"http://".$_SERVER['SERVER_NAME']."/modules/xfmod/community/?shortname\", "
...
$content = "<p>You must be a site administrator in order to create a community."
	. "<p>If you have a suggestion for a community, you are welcome to e-mail that "
	. "suggestion to the <a href=\"mailto:".$xoopsConfig['adminmail']."\">webmaster</a>.";
...
$content = "<p>First off, you must be an administrator of a community in order to perform "
	...
	. "<p>Clicking on the \""._XF_G_ADMIN."\" link in the community menu will take you "
	...
	. "community that will appear in the \""._XF_XFJOBS_NAME."\" section.  This is a good "
	...
	. "the tool in the community menu, then click on the \""._XF_G_ADMIN."\" link that "
	. "appears.";
...
$content = "<p>Communities use FAQs to address topics that are frequently asked in "
	...
	. "contact the <a href=\"mailto:".$xoopsConfig['adminmail']."\">webmaster</a>."
...
$content = "<p>An article is a special type of document.  When articles are enabled for "
	...
	. "\""._XF_COMM_FEATUREDARTICLE."\".  A link will appear to allow users to submit "
...
$content = "<p>Community news indicates the latest developments and information for "
	. "a community."
